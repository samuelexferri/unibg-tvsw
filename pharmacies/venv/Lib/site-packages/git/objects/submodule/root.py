...
class RootUpdateProgress(UpdateProgress):
    ...
    REMOVE, PATHCHANGE, BRANCHCHANGE, URLCHANGE = [
        1 << x
        for x in range(
            UpdateProgress._num_op_codes, UpdateProgress._num_op_codes + 4
        )
    ]
        ...
        try:
            ...
            for i, rsm in enumerate(rrsm):
                ...
                progress.update(
                    ...
                    len_rrsm,
                    prefix
                    + "Removing submodule %r at %s" % (rsm.name, rsm.abspath),
                )
            ...
            for i, csm in enumerate(csms):
             ...
             branch at the new remote, setting it the the remote's tracking branch",
                            ...
                            progress.update(
                                ...
                                len_csms,
                                prefix
                                + "Done adjusting url of submodule %r"
                                % (sm.name),
                            )

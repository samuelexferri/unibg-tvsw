...
class Diff(object):
    ...
    def a_path(self):
        return (
            self.a_rawpath.decode(defenc, "replace")
            if self.a_rawpath
            else None
        )
    ...
    def b_path(self):
        return (
            self.b_rawpath.decode(defenc, "replace")
            if self.b_rawpath
            else None
        )
    ...
    def rename_to(self):
        return (
            self.raw_rename_to.decode(defenc, "replace")
            if self.raw_rename_to
            else None
        )
    ...
    def _index_from_patch_format(cls, repo, proc):
        ...
        handle_process_output(
            proc, text.append, None, finalize_process, decode_streams=False
        )

...
from git.index.fun import aggressive_tree_merge
...
from git.test.lib import TestBase, with_rw_repo, with_rw_directory
...
class TestFun(TestBase):
    ...
    def test_three_way_merge(self, rwrepo):
        ...
        def assert_entries(entries, num_entries, has_conflict=False):
            ...
            assert has_conflict == (
                len([e for e in entries if e.stage != 0]) > 0
            )
    ...
    def test_tree_traversal(self):
        ...
        M = self.rorepo.tree(
            "e14e3f143e7260de9581aee27e5a9b2645db72de"
        )  # merge tree
        B = self.rorepo.tree(
            "f606937a7a21237c866efafcad33675e6539c103"
        )  # base tree
        ...
        # tree trees
        entries = traverse_trees_recursive(
            odb, [B.binsha, H.binsha, M.binsha], ""
        )

...
class TestGit(TestBase):
    ...
    def test_it_transforms_kwargs_into_git_command_arguments(self):
        ...
        self.assertEqual(
            ["-C", "-C"],
            self.git.transform_kwargs(**{"C": [True, True, None, False]}),
        )
    ...
    def test_refresh(self):
        ...
        path = (
            os.popen("{0} git".format(which_cmd)).read().strip().split("\n")[0]
        )
        refresh(path)
    ...
    def test_insert_after_kwarg_raises(self):
        ...
        self.assertRaises(
            ValueError, self.git.remote, "add", insert_kwargs_after="foo"
        )

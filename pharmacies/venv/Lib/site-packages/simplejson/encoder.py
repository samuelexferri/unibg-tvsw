...
def _make_iterencode(
    ...
    def _encode_int(value):
        skip_quoting = (
            _int_as_string_bitcount is None or _int_as_string_bitcount < 1
        )
        ...
        for value in lst:
            ...
            if isinstance(value, string_types):
                ...
                if for_json and callable(for_json):
                    ...
                    _asdict = _namedtuple_as_object and getattr(
                        value, "_asdict", None
                    )
                    if _asdict and callable(_asdict):
                        chunks = _iterencode_dict(
                            _asdict(), _current_indent_level
                        )

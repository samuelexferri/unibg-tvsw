...
class TestScanString(TestCase):
    ...
    def test_c_scanstring(self):
        ...
        self.assertTrue(
            isinstance(simplejson.decoder.c_scanstring('""', 0)[0], str)
        )
    ...
    def _test_scanstring(self, scanstring):
        ...
        self.assertEqual(
            scanstring('["extra comma",]', 2, None, True), (u"extra comma", 14)
        )
        ...
        self.assertEqual(
            scanstring('["Extra close"]]', 2, None, True), (u"Extra close", 14)
        )
        ...
        if sys.maxunicode > 65535:
            self.assertRaises(
                ValueError, scanstring, '\\ud834\\u"', 0, None, True
            )
            self.assertRaises(
                ValueError, scanstring, '\\ud834\\x0123"', 0, None, True
            )
    ...
    def test_overflow(self):
        ...
        self.assertRaises(
            OverflowError, json.decoder.scanstring, "xxx", maxsize + 1
        )
    ...
    def test_surrogates(self):
        ...
        assertScan(u'"z\\ud834\\udd20x"', u"z\U0001d120x")
        assertScan(u'"z\\ud834\\ud834\\udd20x"', u"z\ud834\U0001d120x")
        ...
        assertScan(
            u'"z\\ud834\udd20x12345"', u"".join([u"z\ud834", u"\udd20x12345"])
        )
        ...
        self.assertRaises(
            ValueError, scanstring, u'"z\\ud834\\udd2x"', 1, None, True
        )

...
class TitlePromoter(Transform):
    ...
    def promote_title(self, node):
        ...
        node.update_all_atts_concatenating(
            section, replace=True, and_source=True
        )
    ...
    def promote_subtitle(self, node):
        ...
        # NOTE: Remove `and_source` to NOT copy the 'source'
        #       attribute from section.
        subtitle.update_all_atts_concatenating(
            subsection, replace=True, and_source=True
        )
    ...
    def set_metadata(self):
        ...
        * Document title node (as promoted by promote_title).
        ...
        if not self.document.hasattr("title"):
            ...
            elif len(self.document) and isinstance(
                self.document[0], nodes.title
            ):
...
class DocInfo(Transform):
    ...
    def extract_bibliographic(self, field_list):
        ...
        for field in field_list:
            try:
                ...
                if len(field[-1]) == 1 and isinstance(
    ...
    def authors_from_one_paragraph(self, field):
        ...
        text = "".join(unicode(node) for node in field[1].traverse(nodes.Text))
        if not text:
            raise TransformError
        ...
        authors = [
            [nodes.Text(name, utils.unescape(name, True))]

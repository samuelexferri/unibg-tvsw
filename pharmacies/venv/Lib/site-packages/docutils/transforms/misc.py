    ...
    def apply(self):
        ...
        while parent:
            ...
            for index in range(parent.index(child) + 1, len(parent)):
                ...
                if isinstance(element, nodes.Invisible) or isinstance(
                    element, nodes.system_message
                ):
                    continue
...
class Transitions(Transform):
    ...
    def visit_transition(self, node):
        ...
        if (
            ...
            assert isinstance(node.parent, nodes.document) or isinstance(
                node.parent, nodes.section
            )
            error = self.document.reporter.error(

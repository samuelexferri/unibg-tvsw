...
class Writer(writers.Writer):
    ...
    def update_stylesheet(self, stylesheet_root, language_code, region_code):
        ...
        if language_code is not None or region_code is not None:
            ...
            if not n2_nodes:
                raise RuntimeError(
                    "Cannot find 'default-style' " "element in styles.xml"
                )
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def __init__(self, document):
        ...
        self.language = languages.get_language(
            self.language_code, document.reporter
        )
        self.format_map = {}
        ...
        root = Element(
            "office:document-content", attrib=CONTENT_NAMESPACE_ATTRIB,
        )
    ...
    def retrieve_styles(self, extension):
        ...
        if ext == ".xml":
            ...
            raise RuntimeError(
                "stylesheet path (%s) must be %s or "
    ...
    def add_doc_title(self):
        ...
        if text:
            ...
            if not self.found_doc_title:
                el = Element(
                    "text:p",
                    attrib={"text:style-name": self.rststyle("title"),},
                )
                el.text = text
        ...
        if text == "p":
            ...
            el1 = SubElement(
                ...
                attrib={
                    "text:style-name": self.rststyle(style_name),
                    "text:fixed": "true",
                    "style:data-style-name": "rst-time-style-%d"
                    % self.style_index,
                },
            )
            el2 = SubElement(
            ...
            el3 = SubElement(
                el2, "number:hours", attrib={"number:style": "long",}
            )
            el3 = SubElement(el2, "number:text")
            el3.text = ":"
            el3 = SubElement(
                el2, "number:minutes", attrib={"number:style": "long",}
            )
        elif text == "t2":
            self.style_index += 1
            el1 = SubElement(
            ...
            el3.text = ":"
            el3 = SubElement(
                el2, "number:seconds", attrib={"number:style": "long",}
            )
        elif text == "t3":
            self.style_index += 1
            el1 = SubElement(
            ...
            el1 = SubElement(
                ...
                attrib={
                    "text:style-name": self.rststyle(style_name),
                    "style:data-style-name": "rst-date-style-%d"
                    % self.style_index,
                },
            )
            el2 = SubElement(
            ...
            el3 = SubElement(
                el2, "number:month", attrib={"number:style": "long",}
            )
            el3 = SubElement(el2, "number:text")
            el3.text = "/"
            el3 = SubElement(
                el2, "number:day", attrib={"number:style": "long",}
            )
            el3 = SubElement(el2, "number:text")
            el3.text = "/"
            ...
            el3.text = "/"
            el3 = SubElement(
                el2, "number:year", attrib={"number:style": "long",}
            )
        elif text == "d3":
            self.style_index += 1
            el1 = SubElement(
            ...
            el3 = SubElement(
                el2, "number:month", attrib={"number:textual": "true",}
            )
            el3 = SubElement(el2, "number:text")
            el3.text = " "
            ...
            el3 = SubElement(
                el2,
                "number:month",
                attrib={"number:textual": "true", "number:style": "long",},
            )
            el3 = SubElement(el2, "number:text")
            el3.text = " "
            el3 = SubElement(el2, "number:day", attrib={})
            ...
            el1 = SubElement(
                parent, "text:author-name", attrib={"text:fixed": "false",}
            )
        else:
            el1 = None
        return el1
    ...
    def visit_bullet_list(self, node):
        ...
        if self.in_table_of_contents:
            if self.settings.generate_oowriter_toc:
                ...
                if (
                    "classes" in node
                    and "auto-toc" in node.attributes["classes"]
                ):
                    el = SubElement(
            ...
            if self.blockstyle == self.rststyle("blockquote"):
                ...
                el = SubElement(
                    self.current_element,
                    "text:list",
                    attrib={"text:style-name": self.rststyle("bulletlist"),},
                )
                self.list_style_stack.append(self.rststyle("bulletitem"))
            self.set_current_element(el)
    ...
    def visit_enumerated_list(self, node):
        ...
        if self.blockstyle == self.rststyle("blockquote"):
            ...
            el2 = SubElement(
                el1,
                "text:list",
                attrib={"text:style-name": self.rststyle(liststylename),},
            )
            self.list_style_stack.append(self.rststyle("enumitem"))
    ...
    def visit_footnote_reference(self, node):
        if self.footnote_level <= 0:
            ...
            if isinstance(node, docutils.nodes.citation_reference):
                ...
                el2 = SubElement(
                    el1, "text:note-citation", attrib={"text:label": citation,}
                )
                el2.text = citation
            elif note_auto == "1":
                el2 = SubElement(
                ...
                el2 = SubElement(
                    el1,
                    "text:note-citation",
                    attrib={"text:label": footnote_char,},
                )
        ...
        if isinstance(node.parent, docutils.nodes.footnote):
            ...
            if self.settings.create_links:
                ...
                self.append_child(
                    ...
                    attrib={"text:name": "%s" % (self.citation_id,),},
                )
            else:
                el.text = "["
    ...
    def visit_image(self, node):
        ...
        if isinstance(node.parent, docutils.nodes.figure):
            ...
            el6, width = self.generate_image(
                node, source, destination, el5, attrib
            )
    ...
    def generate_figure(self, node, source, destination, current_element):
        ...
        if caption is not None:
            ...
            SubElement(
                el1, "style:paragraph-properties", attrib=attrib, nsdict=SNSD
            )
            attrib = {
                "fo:font-size": "12pt",
            ...
            SubElement(
                el1, "style:text-properties", attrib=attrib, nsdict=SNSD
            )
    ...
    def visit_math(self, node):
        self.document.reporter.warning(
            '"math" role not supported', base_node=node
        )
    ...
    def visit_math_block(self, node):
        self.document.reporter.warning(
            '"math" directive not supported', base_node=node
        )
    ...
    def visit_option_list(self, node):
        ...
        el4 = SubElement(
            el3, "text:p", attrib={"text:style-name": "Table_20_Heading"}
        )
        el4.text = "Option"
        el3 = SubElement(
            el2,
    ...
    def visit_description(self, node):
        ...
        el1 = SubElement(
            el, "text:p", attrib={"text:style-name": "Table_20_Contents"}
        )
        el1.text = node.astext()
        raise nodes.SkipChildren()
    ...
    def visit_paragraph(self, node):
        ...
        if self.in_header:
            ...
            el = self.append_child(
                "text:p", attrib={"text:style-name": style_name}
            )
    ...
    def visit_colspec(self, node):
        ...
        self.append_child(
            "table:table-column", attrib={"table:style-name": colspec_name,}
        )
    ...
    def visit_entry(self, node):
        ...
        cellspec_name = self.rststyle(
            "%s%%d.%%c%%d" % TABLESTYLEPREFIX, (self.table_count, "A", 1,)
        )
        attrib = {
    ...
    def visit_title(self, node, move_ids=1, title_type="title"):
        if isinstance(node.parent, docutils.nodes.section):
            ...
            el1 = SubElement(
                self.current_element,
                "text:p",
                attrib={"text:style-name": self.rststyle(title_type),},
            )
            self.append_pending_ids(el1)
            text = node.astext()
            self.title = text
    ...
    def generate_table_of_content_entry_template(self, el1):
        for idx in range(1, 11):
            ...
            SubElement(
                ...
                attrib={"style:leader-char": ".", "style:type": "right",},
            )
            ...
            if "contents" in node.attributes["classes"]:
                ...
                if self.settings.generate_oowriter_toc:
                    ...
                    el2 = SubElement(
                        ...
                        attrib={"text:outline-level": "10",},
                    )
                    el3 = SubElement(
                        el2,
                        "text:index-title-template",
                        attrib={"text:style-name": "Contents_20_Heading",},
                    )
                    el3.text = label
                ...
                label = self.find_title_label(
                    node, docutils.nodes.title, "abstract"
                )
                el1.text = label
                ...
                label = self.find_title_label(
                    node, docutils.nodes.title, "dedication"
                )
                el1.text = label
    ...
    def visit_subscript(self, node):
        el = self.append_child(
            "text:span", attrib={"text:style-name": "rststyle-subscript",}
        )
        self.set_current_element(el)
    ...
    def visit_superscript(self, node):
        el = self.append_child(
            "text:span", attrib={"text:style-name": "rststyle-superscript",}
        )
        self.set_current_element(el)

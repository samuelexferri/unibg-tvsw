...
class Publisher(object):
    ...
    def process_programmatic_settings(
        self, settings_spec, settings_overrides, config_section
    ):
    ...
    def publish(
        ...
        try:
            ...
            self.document = self.reader.read(
                self.source, self.parser, self.settings
            )
        ...
        if (
            ...
            and self.document
            and (
                self.document.reporter.max_level
    ...
    def debugging_dumps(self):
            ...
            print(
                pprint.pformat(
                    [
                        (
                            priority,
                            "%s.%s" % (xclass.__module__, xclass.__name__),
                            pending and pending.details,
                            kwargs,
                        )
        ...
        if self.settings.dump_pseudo_xml:
            ...
            print(
                self.document.pformat().encode("raw_unicode_escape"),
                file=self._stderr,
            )

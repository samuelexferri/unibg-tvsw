...
schemes = {
    ...
    "data": (
        'allows inclusion of small data items as "immediate" data; ' "RFC 2397"
    ),
    ...
    "fax": (
        "a connection to a terminal that can handle telefaxes "
        "(facsimiles); RFC 2806"
    ),
    ...
    "h323": (
        "video (audiovisual) communication on local area networks; " "RFC 3508"
    ),
    "h324": (
    ...
    "jar": "Java archive",
    "javascript": (
        "JavaScript code; evaluates the expression after the " "colon"
    ),
    ...
    "mocha": "",
    "modem": (
        "a connection to a terminal that can handle incoming data "
        "calls; RFC 2806"
    ),
    ...
    "x-man-page": (
        "Opens man page in Terminal.app on OS X " "(see macosxhints.com)"
    ),

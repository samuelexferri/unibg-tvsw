...
class CloseableSignupMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        try:
            ...
            return e.response
        return super(CloseableSignupMixin, self).dispatch(
            request, *args, **kwargs
        )
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def get_form_class(self):
        return get_form_class(
            app_settings.FORMS, "change_password", self.form_class
        )
...
class PasswordSetView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def get_form_class(self):
        return get_form_class(
            app_settings.FORMS, "set_password", self.form_class
        )
...
class PasswordResetView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def get_form_class(self):
        return get_form_class(
            app_settings.FORMS, "reset_password", self.form_class
        )

...
class AccountTests(TestCase):
    ...
    def _test_signup_email_verified_externally(
        self, signup_email, verified_email
    ):
        username = "johndoe"
    ...
    def test_ajax_password_change(self):
        ...
        assert (
            "same password" in data["form"]["fields"]["password2"]["errors"][0]
        )
    ...
    def test_password_reset_flow(self):
        ...
        self.assertRedirects(
            resp, reverse("account_reset_password_from_key_done")
        )
    ...
    def test_email_escaping(self):
        ...
        u = get_user_model().objects.create(
            username="test", email="user@example.com"
        )
...
class UtilsTests(TestCase):
    ...
    def test_url_str_to_pk_identifies_UUID_as_stringlike(self):
        with patch("allauth.account.utils.get_user_model") as mocked_gum:
            ...
            self.assertEqual(
                url_str_to_user_pk(self.user_id), uuid.UUID(self.user_id)
            )
...
class ConfirmationViewTests(TestCase):
    ...
    def test_login_on_confirm_uuid_user(self, mocked_gum, mock_perform_login):
        ...
        with patch(
            "allauth.account.views.EmailConfirmationHMAC", confirmation
        ):

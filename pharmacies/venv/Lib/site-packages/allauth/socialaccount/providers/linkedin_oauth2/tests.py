...
"""
        acc = SocialAccount(
            extra_data=loads(extra_data), provider="linkedin_oauth2",
        )
    ...
    @override_settings(
        SOCIALACCOUNT_PROVIDERS={
            "linkedin_oauth2": {
                ...
                "PROFILEPICTURE": {"display_size_w_h": (100, 100.0),},
            },
        }
    )
    ...
    @override_settings(
        SOCIALACCOUNT_PROVIDERS={
            "linkedin_oauth2": {
                ...
                "PROFILEPICTURE": {"display_size_w_h": (100, 100),},
            },
        }
    )
...
"""
        ...
        self.assertRaises(
            ProviderException, provider.extract_uid, loads(extra_data)
        )

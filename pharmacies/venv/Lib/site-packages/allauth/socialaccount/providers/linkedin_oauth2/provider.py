...
class LinkedInOAuth2Account(ProviderAccount):
    ...
    def get_avatar_url(self):
        ...
        configured_profile_fields = provider_configuration.get(
            "PROFILE_FIELDS", []
        )
        ...
        profile_picture_config = provider_configuration.get(
            "PROFILEPICTURE", {}
        )
        req_size = profile_picture_config.get(
            "display_size_w_h", (100.0, 100.0)
        )
        req_auth_method = profile_picture_config.get(
        ...
        for single_element in profile_elements:
            ...
            to_return = single_element.get("identifiers", [{},])[0].get(
                "identifier"
            )
            if to_return:
                return to_return

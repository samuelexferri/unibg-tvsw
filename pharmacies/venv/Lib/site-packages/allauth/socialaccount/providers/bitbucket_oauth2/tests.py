...
class BitbucketOAuth2Tests(
    ...
    def test_account_tokens(self, multiple_login=False):
        ...
        calls = [
            ...
            mock.call(
                "https://api.bitbucket.org/2.0/user/emails", params=mock.ANY
            ),
        ]
        if multiple_login:
            calls.extend(
                [
                    mock.call(
                        "https://api.bitbucket.org/2.0/user", params=mock.ANY
                    ),
                    mock.call(
    ...
    def test_provider_account(self):
        ...
        self.assertEqual(
            account.get_profile_url(), "https://bitbucket.org/tutorials"
        )
        self.assertEqual(

...
class DebugControl(object):
    ...
    def __init__(self, options, output):
        ...
        self.output = DebugOutputFile.get_one(
            output, show_process=self.should("process"), filters=filters,
        )
        self.raw_output = self.output.outfile

    def __repr__(self):
        return "<DebugControl options=%r raw_output=%r>" % (
            self.options,
            self.raw_output,
        )
...
class DebugOutputFile(object):  # pragma: debugging
    ...
    def __init__(self, outfile, show_process, filters):
        ...
        if self.show_process:
            ...
            if hasattr(os, "getppid"):
                self.write(
                    "New process: pid: %r, parent pid: %r\n"
    ...
    @classmethod
    def get_one(
        cls, fileobj=None, show_process=True, filters=(), interim=False
    ):
    ...
    def _decorator(func):
        ...
        def _wrapper(self, *args, **kwargs):
            ...
            if show_args:
                ...
                ekwargs = ", ".join(
                    "{}={!r}".format(*item) for item in kwargs.items()
                )
                extra += "("
                extra += eargs

...
class Opts(object):
    ...
    help = optparse.make_option(
        "-h", "--help", action="store_true", help="Get help on this command.",
    )
    ...
    skip_empty = optparse.make_option(
        "--skip-empty", action="store_true", help="Skip files with no code.",
    )
...
class CoverageOptionParser(optparse.OptionParser, object):
    ...
    def parse_args_ok(self, args=None, options=None):
        ...
        """
        try:
            options, args = super(CoverageOptionParser, self).parse_args(
                args, options
            )
...
class CmdOptionParser(CoverageOptionParser):
    ...
    def __init__(
        self, action, options, defaults=None, usage=None, description=None
    ):
    ...
    def get_prog_name(self):
        ...
        return "{command} {subcommand}".format(
...
CMDS = {
    "annotate": CmdOptionParser(
        "annotate",
        [Opts.directory, Opts.ignore_errors, Opts.include, Opts.omit,]
        + GLOBAL_ARGS,

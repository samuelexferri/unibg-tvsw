...
if env.PY3:
    ...
    new_contract(
        "blob", lambda v: isinstance(v, buffer)
...
def numbits_union(numbits1, numbits2):
    ...
    """
    byte_pairs = zip_longest(
        bytes_to_ints(numbits1), bytes_to_ints(numbits2), fillvalue=0
    )
...
def register_sqlite_functions(connection):
    ...
    * :func:`numbits_to_nums`
    ...
    connection.create_function(
        "numbits_any_intersection", 2, numbits_any_intersection
    )

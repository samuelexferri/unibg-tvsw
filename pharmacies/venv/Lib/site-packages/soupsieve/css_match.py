...
class _DocumentNav(object):
    ...
    def is_root(self, el):
        ...
        if not root:
            ...
            root = (
                parent is not None and self.is_html and self.is_iframe(parent)
            )
        return root
    ...
    def split_namespace(el, attr_name):
        ...
        return (
            getattr(attr_name, "namespace", None),
            getattr(attr_name, "name", None),
        )
...
class _Match(object):
    ...
    def match_namespace(self, el, tag):
        ...
        tag_ns = (
            "" if tag.prefix is None else self.namespaces.get(tag.prefix, None)
        )

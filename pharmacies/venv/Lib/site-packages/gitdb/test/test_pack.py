...
class TestPack(TestBase):
    ...
    packindexfile_v1 = (
        fixture_path(
            "packs/pack-c0438c19fb16422b6bbcce24387b3264416d485b.idx"
        ),
        1,
        67,
    )
    packindexfile_v2 = (
        fixture_path(
            "packs/pack-11fdfa9e156ab73caae3b6da867192221f2089c2.idx"
        ),
        2,
        30,
    )
    packindexfile_v2_3_ascii = (
        fixture_path(
            "packs/pack-a2bf8e71d8c18879e499335762dd95119d93d9f1.idx"
        ),
        2,
        42,
    )
    ...
    packfile_v2_3_ascii = (
        fixture_path(
            "packs/pack-a2bf8e71d8c18879e499335762dd95119d93d9f1.pack"
        ),
        2,

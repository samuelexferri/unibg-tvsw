    ...
    def load(cls, value):
        ...
        for attr in dir(cls):
            ...
            if (
                ...
                and attr_value["string"] is not None
...
class Proxy(object):
    ...
    def __init__(self, raw=None):
        ...
        if raw is not None:
            ...
            if (
                "proxyAutoconfigUrl" in raw
                and raw["proxyAutoconfigUrl"] is not None
            ):
    ...
    def _verify_proxy_type_compatibility(self, compatibleProxy):
        if (
            self.proxyType != ProxyType.UNSPECIFIED
            and self.proxyType != compatibleProxy
        ):
            raise Exception(

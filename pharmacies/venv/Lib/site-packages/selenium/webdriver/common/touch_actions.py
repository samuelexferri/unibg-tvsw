...
class TouchActions(object):
    ...
    def tap_and_hold(self, xcoord, ycoord):
        ...
        self._actions.append(
            lambda: self._driver.execute(
                Command.TOUCH_DOWN, {"x": int(xcoord), "y": int(ycoord)}
            )
        )
        return self
    ...
    def move(self, xcoord, ycoord):
        ...
        self._actions.append(
            lambda: self._driver.execute(
                Command.TOUCH_MOVE, {"x": int(xcoord), "y": int(ycoord)}
            )
        )
        return self
    ...
    def release(self, xcoord, ycoord):
        ...
        self._actions.append(
            lambda: self._driver.execute(
                Command.TOUCH_UP, {"x": int(xcoord), "y": int(ycoord)}
            )
        )
        return self
    ...
    def flick(self, xspeed, yspeed):
        ...
        self._actions.append(
            lambda: self._driver.execute(
                Command.FLICK, {"xspeed": int(xspeed), "yspeed": int(yspeed)}
            )
        )
        return self

...
class WebDriver(object):
    ...
    def __init__(
        ...
        if proxy is not None:
            warnings.warn(
                "Please use FirefoxOptions to set proxy",
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        if type(self.command_executor) is bytes or isinstance(
            ...
            self.command_executor = RemoteConnection(
                command_executor, keep_alive=keep_alive
            )
        ...
        if browser_profile is not None:
            warnings.warn(
                "Please use FirefoxOptions to set browser profile",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def _unwrap_value(self, value):
        if isinstance(value, dict):
            if (
                "ELEMENT" in value
                or "element-6066-11e4-a52e-4f735466cecf" in value
            ):
    ...
    def switch_to_active_element(self):
        ...
        """
        warnings.warn(
            "use driver.switch_to.active_element instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def switch_to_frame(self, frame_reference):
        ...
        """
        warnings.warn(
            "use driver.switch_to.frame instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def switch_to_default_content(self):
        ...
        """
        warnings.warn(
            "use driver.switch_to.default_content instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def switch_to_alert(self):
        ...
        """
        warnings.warn(
            "use driver.switch_to.alert instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def implicitly_wait(self, time_to_wait):
        ...
        if self.w3c:
            ...
            self.execute(
                Command.IMPLICIT_WAIT, {"ms": float(time_to_wait) * 1000}
            )
    ...
    def set_script_timeout(self, time_to_wait):
        ...
        if self.w3c:
            ...
            self.execute(
                Command.SET_SCRIPT_TIMEOUT, {"ms": float(time_to_wait) * 1000}
            )
    ...
    def find_elements(self, by=By.ID, value=None):
        ...
        return (
            self.execute(Command.FIND_ELEMENTS, {"using": by, "value": value})[
                "value"
            ]
            or []
        )
    ...
    def get_screenshot_as_png(self):
        ...
        return base64.b64decode(
            self.get_screenshot_as_base64().encode("ascii")
        )
    ...
    def set_window_position(self, x, y, windowHandle="current"):
        ...
        if self.w3c:
            ...
            self.execute(
                ...
                {"x": int(x), "y": int(y), "windowHandle": windowHandle},
            )
    ...
    def get_window_position(self, windowHandle="current"):
        ...
        if self.w3c:
            ...
            position = self.execute(
                Command.GET_WINDOW_POSITION, {"windowHandle": windowHandle}
            )["value"]

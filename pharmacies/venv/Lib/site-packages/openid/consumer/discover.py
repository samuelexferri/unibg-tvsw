...
class OpenIDServiceEndpoint(object):
    ...
    def preferredNamespace(self):
        if (
            OPENID_IDP_2_0_TYPE in self.type_uris
            or OPENID_2_0_TYPE in self.type_uris
        ):
    ...
    def parseService(self, yadis_url, uri, type_uris, service_element):
        ...
        if not self.isOPIdentifier():
            ...
            # think I care.
            self.local_id = findOPLocalIdentifier(
                service_element, self.type_uris
            )
    ...
    def fromDiscoveryResult(cls, discoveryResult):
        ...
        if discoveryResult.isXRDS():
            ...
            method = cls.fromHTML
        return method(
            discoveryResult.normalized_uri, discoveryResult.response_text
        )

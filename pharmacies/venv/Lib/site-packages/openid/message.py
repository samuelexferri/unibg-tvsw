...
class Message(object):
    ...
    def toFormMarkup(
        self, action_url, form_tag_attrs=None, submit_text="Continue"
    ):
        ...
        return str(
            ElementTree.tostring(form, encoding="utf-8"), encoding="utf-8"
        )
    ...
    def _fixNS(self, namespace):
        ...
        if namespace != BARE_NS and ":" not in namespace:
            ...
            if namespace == "sreg":
                ...
                warnings.warn(
                    fmt % (SREG_URI,), DeprecationWarning,
                )
                return SREG_URI
...
class NamespaceMap(object):
    ...
    def addAlias(self, namespace_uri, desired_alias, implicit=False):
        ...
        if (
            current_namespace_uri is not None

...
class GherkinLexer(RegexLexer):
    ...
    tokens = {
        ...
        "table_vars": [(r"(<[^>]+>)", Name.Variable),],
        "numbers": [(r"(\d+\.?\d*|\d*\.\d+)([eE][+-]?[0-9]+)?", String),],
        "string": [include("table_vars"), (r"(\s|.)", String),],
        "py_string": [(r'"""', Keyword, "#pop"), include("string"),],
        "step_content_root": [
            (r"$", Keyword, "#pop"),
        ...
        "double_string": [(r'"', Name.Function, "#pop"), include("string"),],
        "root": [
            (r"\n", Name.Function),
            include("comments"),
            (r'"""', Keyword, "py_string"),

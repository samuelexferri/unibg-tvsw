    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Keyword, Text, Keyword, Text, Name.Function, Punctuation
                ),
                "arglist",
            ),
            (
...
class ApacheConfLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"([a-z]\w*)(\s+)", bygroups(Name.Builtin, Text), "value"),
            (r"\.+", Text),
        ],
        "value": [
            (r"\\\n", Text),
...
class TerraformLexer(RegexLexer):
    ...
    tokens = {
        ...
        "var_builtin": [
            ...
            (
                words(
                    ("concat", "file", "join", "lookup", "element"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Name.Builtin,
        ...
        # Tokens for { }
        "curly": [(r"\{", Text.Punctuation), (r"\}", Text.Punctuation),],
        "comment": [
            (r"[^*/]", Comment.Multiline),
...
class TermcapLexer(RegexLexer):
    ...
    tokens = {
        "root": [(r"^#.*$", Comment), (r"^[^\s#:|]+", Name.Tag, "names"),],
        "names": [
            (r"\n", Text, "#pop"),
            (r":", Punctuation, "defs"),
            (r"\|", Punctuation),
...
class PkgConfigLexer(RegexLexer):
    ...
    tokens = {
        ...
        "curly": [(r"\}", String.Interpol, "#pop"), (r"\w+", Name.Attribute),],
        "spvalue": [
            include("interp"),

...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "class": [
            (
                u"(%s|%s|`[^`]+`)(\\s*)(\\[)" % (idrest, op),
                bygroups(Name.Class, Text, Operator),
                ("#pop", "typeparam"),
            ),
            (r"\s+", Text),
            include("comments"),
        ...
        "import": [(u"(%s|\\.)+" % idrest, Name.Namespace, "#pop")],
        "interpstringcommon": [
            (r'[^"$\\]+', String),
            (r"\$\$", String),
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                r"true|try|val|var|vararg|when|where|while)\b",
                Keyword,
            ),
            (kt_id, Name),
        ],
        "package": [(r"\S+", Name.Namespace, "#pop")],
        "class": [(kt_id, Name.Class, "#pop")],
        "property": [(kt_id, Name.Property, "#pop")],
        "property_dec": [
...
class GoloLexer(RegexLexer):
    ...
    tokens = {
        ...
        "varname": [(r"`?[a-zA-Z_][\w$]*", Name.Variable, "#pop"),],
        "string": [(r'[^\\\'"\n]+', String), (r'[\'"\\]', String)],
        "stringescape": [
            (
                r'\\([\\abfnrtv"\']|\n|N\{.*?\}|u[a-fA-F0-9]{4}|'
        ...
        "doublestring": [(r'"', String.Double, "#pop"), include("string"),],
        "singlestring": [(r"'", String, "#pop"), include("string"),],
        "operators": [
            (r"[#=,./%+\-?]", Operator),
            (r"(eq|gt|lt|gte|lte|neq|matches)\b", Operator),
            (r"(==|<=|<|>=|>|!=)", Operator),
    ...
    tokens = {
        "default": [
            ...
            (
                ...
                r"synchronized|synthetic|transient|varargs|volatile)%s"
                % _break,
                Keyword.Reserved,
            ),
...
class SarlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(abstract|def|dispatch|final|native|override|private|protected|public|static|strictfp|synchronized|transient|val|var|volatile)\b",
                Keyword.Declaration,
            ),
            (
                r"(boolean|byte|char|double|float|int|long|short|void)\b",
            ...
            (
                r"(agent|annotation|artifact|behavior|capacity|class|enum|event|interface|skill|space)(\s+)",
                bygroups(Keyword.Declaration, Text),
                "class",
            ),
            (r"(import)(\s+)", bygroups(Keyword.Namespace, Text), "import"),

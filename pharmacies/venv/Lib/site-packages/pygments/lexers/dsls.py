...
class ProtoBufLexer(RegexLexer):
    ...
    tokens = {
        ...
        "message": [(r"[a-zA-Z_]\w*", Name.Class, "#pop"), default("#pop"),],
        "type": [(r"[a-zA-Z_]\w*", Name, "#pop"), default("#pop"),],
    }
...
class ThriftLexer(RegexLexer):
    ...
    tokens = {
        ...
        "whitespace": [(r"\n", Text.Whitespace), (r"\s+", Text.Whitespace),],
        "comments": [
            (r"#.*$", Comment),
            (r"//.*?\n", Comment),
        ...
        "class": [(r"[a-zA-Z_]\w*", Name.Class, "#pop"), default("#pop"),],
        "keywords": [
    ...
    tokens = {
        ...
        "types": [
            ...
            (
                ...
                bygroups(
                    Keyword.Type, Text, Operator.Word, Text, Keyword.Type
                ),
            ),
            (
...
class AlloyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "module": [text_tuple, (iden_rex, Name, "#pop"),],
        "fun": [
            text_tuple,
            (r"\{", Operator, "#pop"),
            (iden_rex, Name, "#pop"),
...
class PanLexer(RegexLexer):
    ...
    tokens = {
        ...
        "paren": [(r"\)", Keyword, "#pop"), include("root"),],
    }
...
class SnowballLexer(ExtendedRegexLexer):
    ...
    def _stringescapes(lexer, match, ctx):
        ...
        return bygroups(
            Keyword.Reserved, Text, String.Escape, Text, String.Escape
        )(lexer, match, ctx)
    ...
    tokens = {
        ...
        "string": [(r"[^']*'", _string(True)),],
        "escape": [(r"[^']*'", _string(False)),],
    }

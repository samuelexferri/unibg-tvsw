...
class CSharpLexer(RegexLexer):
    ...
    for levelname, cs_ident in iteritems(levels):
        tokens[levelname] = {
            ...
            "class": [(cs_ident, Name.Class, "#pop"), default("#pop"),],
            "namespace": [
...
class VbNetLexer(RegexLexer):
    ...
    tokens = {
        ...
        "funcname": [(uni_name, Name.Function, "#pop"),],
...
class CSharpAspxLexer(DelegatingLexer):
    ...
    def __init__(self, **options):
        super(CSharpAspxLexer, self).__init__(
            CSharpLexer, GenericAspxLexer, **options
        )
...
class VbNetAspxLexer(DelegatingLexer):
    ...
    def __init__(self, **options):
        super(VbNetAspxLexer, self).__init__(
            VbNetLexer, GenericAspxLexer, **options
        )

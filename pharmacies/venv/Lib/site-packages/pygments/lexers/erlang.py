    ...
    tokens = {
        ...
        "directive": [
            (
                ...
                bygroups(Name.Entity, Text, Punctuation, Name.Constant),
                "#pop",
            ),
            (
                r"(record)(\s*)(\()(" + macro_re + r")",
                bygroups(Name.Entity, Text, Punctuation, Name.Label),
                "#pop",
            ),
...
class ElixirLexer(RegexLexer):
    ...
    tokens = {
        ...
        "interpol": [(r"#\{", String.Interpol, "interpol_string"),],
        ...
        "tuple": [include("root"), (r"\}", Punctuation, "#pop"),],
    }

...
class CssLexer(RegexLexer):
    ...
    tokens = {
        ...
        "atcontent": [include("basics"), (r"\}", Punctuation, "#pop:2"),],
        "content": [
            (r"\s+", Text),
            (r"\}", Punctuation, "#pop"),
            (r";", Punctuation),
            ...
            (
                r"([a-zA-Z_][\w-]*)(\s*)(\:)",
                bygroups(Name, Text, Punctuation),
                "value-start",
            ),
            (r"/\*(?:.|\n)*?\*/", Comment),
        ],
...
class SassLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "single-comment": [(r".+", Comment.Single), (r"\n", Text, "root"),],
        "multi-comment": [(r".+", Comment.Multiline), (r"\n", Text, "root"),],
        "import": [
            (r"[ \t]+", Text),
            (r"\S+", String),
            (r"\n", Text, "root"),
...
class LessCssLexer(CssLexer):
    ...
    tokens = {
        "root": [(r"@\w+", Name.Variable), inherit,],
        "content": [(r"\{", Punctuation, "#push"), inherit,],
    }

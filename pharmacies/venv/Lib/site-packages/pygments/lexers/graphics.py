...
class GnuplotLexer(RegexLexer):
    ...
    tokens = {
        ...
        "whitespace": [("#", Comment, "comment"), (r"[ \t\v\f]+", Text),],
        "noargs": [
            include("whitespace"),
        ...
        "quit": [(r"gnuplot\b", Keyword), include("noargs"),],
        "fit": [(r"via\b", Name.Builtin), include("plot"),],
        "if": [(r"\)", Punctuation, "#pop"), include("genericargs"),],
        "pause": [

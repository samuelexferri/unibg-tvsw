...
class Inform6Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "_expression": [
            ...
            (r"(?=sp\b)", Text, "#pop"),
            (
                r"(?=[%s%s$0-9#a-zA-Z_])" % (_dquote, _squote),
                Text,
                ("#pop", "value"),
            ),
    ...
    for level in token_variants:
        tokens[level] = {
            ...
            "+heading?": [
                ...
                (r"[%s]{1,3}" % _dash, Text),
                (
                    r"(?i)(volume|book|part|chapter|section)\b[^%s]*"
                    % _newline,
                    Generic.Heading,
                    "#pop",
                ),

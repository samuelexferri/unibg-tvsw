...
class BashLexer(RegexLexer):
    ...
    tokens = {
        ...
        "backticks": [(r"`", String.Backtick, "#pop"), include("root"),],
    }
...
class BatchLexer(RegexLexer):
    ...
    _core_token_compound = r'(?:(?:(?:\^[%s]?)?[^"%s%s%s)])+)' % (
        _nl,
        _nl,
        _punct,
        _ws,
        ...
        return [
            ...
            (
                ...
                % (
                    ...
                    _nl,
                    _space,
                    stoken_compound if compound else _stoken,
                ),
                bygroups(
    ...
    tokens = {
        ...
        "if": [
            ...
            (
                r"(%s%s)(%s)(%s%s)"
                % (_number, _space, _opword, _space, _number),
                bygroups(
...
class PowerShellLexer(RegexLexer):
    ...
    tokens = {
        ...
        "child": [(r"\)", Punctuation, "#pop"), include("root"),],
        "multline": [
            (r"[^#&.]+", Comment.Multiline),

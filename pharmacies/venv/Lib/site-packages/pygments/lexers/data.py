...
class YamlLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "block-scalar-content": [
            ...
            (r"\n", Text),
            # empty line
            (r"^[ ]+$", parse_block_scalar_empty_line(Text, Name.Constant)),
...
class JsonBareObjectLexer(JsonLexer):
    ...
    tokens = {
        "root": [(r"\}", Error), include("objectvalue"),],
        "objectattribute": [(r"\}", Error), inherit,],
    }
    ...
    tokens = {
        "objectvalue": [
            (
                ...
                r'reverse|index|base|vocab|graph)"',
                Name.Decorator,
                "objectattribute",
            ),
            inherit,

...
class LuaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "goto": [include("ws"), (_name, Name.Label, "#pop"),],
        "label": [
            include("ws"),
            (r"::", Punctuation, "#pop"),
            (_name, Name.Label),
        ...
        "sqs": [(r"'", String.Single, "#pop"), (r"[^\\']+", String.Single),],
        "dqs": [(r'"', String.Double, "#pop"), (r'[^\\"]+', String.Double),],
    }
...
class MoonScriptLexer(LuaLexer):
    ...
    tokens = {
        "root": [(r"#!(.*?)$", Comment.Preproc), default("base"),],
        "base": [
            ("--.*$", Comment.Single),
            (r"(?i)(\d*\.\d+|\d+\.\d*)(e[+-]?\d+)?", Number.Float),
            (r"(?i)\d+e[+-]?\d+", Number.Float),
...
class AppleScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\(\*", Comment.Multiline, "comment"),
            (r"[(){}!,.:]", Punctuation),
            (u"(«)([^»]+)(»)", bygroups(Text, Name.Builtin, Text)),
            (

...
class Modula2Lexer(RegexLexer):
    ...
    reserved_words_db = {
        ...
        "m2pim": (common_reserved_words, pim_additional_reserved_words,),
        # Reserved words for Modula-2 R10
        "m2iso": (common_reserved_words, iso_additional_reserved_words,),
        # Reserved words for ISO Modula-2
        "m2r10": (common_reserved_words, m2r10_additional_reserved_words,),
    ...
    builtins_db = {
        ...
        "m2pim": (common_builtins, pim_additional_builtins,),
        # Builtins for ISO Modula-2
        "m2iso": (common_builtins, iso_additional_builtins,),
        # Builtins for ISO Modula-2
        "m2r10": (common_builtins, m2r10_additional_builtins,),
    ...
    pseudo_builtins_db = {
        ...
        # Builtins for ISO Modula-2
        "m2r10": (common_pseudo_builtins, m2r10_additional_pseudo_builtins,),
        # Builtins for Objective Modula-2
        "objm2": (
            common_pseudo_builtins,
            m2r10_additional_pseudo_builtins,

    ...
    return {
        "root": [
            ...
            (
                "(" + hex_re + "+)( )(<)(.*?)(>:)$",
                bygroups(
                    Number.Hex, Text, Punctuation, Name.Function, Punctuation
                ),
            ),
            ...
            (
                ...
                + " )+)( *\t)([a-zA-Z].*?)$",
                bygroups(
                    Text, Name.Label, Text, Number.Hex, Text, using(asm_lexer)
                ),
            ),
            ...
            (
                r"(\t\t\t)(" + hex_re + r"+:)( )([^\t]+)(\t)(.*?)$",
                bygroups(
                    Text, Name.Label, Text, Name.Property, Text, Name.Constant
                ),
            ),
            (r"[^\n]+\n", Other),
        ]
...
class CppObjdumpLexer(DelegatingLexer):
    ...
    def __init__(self, **options):
        super(CppObjdumpLexer, self).__init__(
            CppLexer, ObjdumpLexer, **options
        )

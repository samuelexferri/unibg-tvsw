    ...
    tokens = {
        ...
        "operator": [
            ...
            (
                ...
                bygroups(
                    Keyword, Text, Keyword, Text, Keyword, Text, Name.Variable
                ),
                "varname",
            ),
            # (r'\)|\?|\]', Punctuation, '#push'),
        ...
        "pragma": [(qname, Name.Variable, "pragmacontents"),],
        "pragmacontents": [
        ...
        "option": [include("whitespace"), (qname, Name.Variable, "#pop"),],
        "qname_braren": [
            include("whitespace"),
            (r"(\{)", pushstate_operator_root_callback),
            (r"(\()", Punctuation, "root"),
        ],
        "element_qname": [(qname, Name.Variable, "root"),],
        "attribute_qname": [(qname, Name.Variable, "root"),],
        "root": [
            include("whitespace"),
            (r"\(:", Comment, "comment"),
            ...
            (
                ...
                bygroups(Keyword.Pseudo, Text, Keyword.Pseudo),
                "namespacekeyword",
            ),
            (
            ...
            (
                r"(declare)(\s+)(\%)",
                bygroups(Keyword.Declaration, Text, Name.Decorator),
                "annotationname",
            ),
            # ITEMTYPE
            (r"(\))(\s+)(as)", bygroups(Operator, Text, Keyword), "itemtype"),
            ...
            (
                r"(catch)(\s*)(\()(\$)",
                bygroups(Keyword, Text, Punctuation, Name.Variable),
                "varname",
            ),

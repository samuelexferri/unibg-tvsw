    ...
    for key in clean_dict:
        ...
        if v is not None:
            if isinstance(v, datetime.datetime):
                ...
                v, (six.string_types, six.integer_types, float)
            ):
...
class ModelCode(Code):
    ...
    def __init__(
        self, model, context=None, stdout=None, stderr=None, options=None
    ):
...
class InstanceCode(Code):
    ...
    def __init__(
        ...
        super(InstanceCode, self).__init__(
            indent=0, stdout=stdout, stderr=stderr
        )
        self.imports = {}
    ...
    def instantiate(self):
        ...
        if not self.instantiated:
            code_lines.append(
                "%s = %s()" % (self.variable_name, self.model.__name__)
            )
...
class Script(Code):
    ...
    def __init__(
        self, models, context=None, stdout=None, stderr=None, options=None
    ):
    ...
    def _queue_models(self, models, context):
        ...
        while number_remaining_models > 0:
            ...
            if check_dependencies(
                model, model_queue, context["__avaliable_models"]
            ):
...
def get_attribute_value(
    item, field, context, force=False, skip_autofield=True
):

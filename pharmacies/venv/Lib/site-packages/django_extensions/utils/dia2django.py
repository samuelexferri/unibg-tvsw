...
def dia2django(archivo):
        ...
        if i.getAttribute("type") == "UML - Class":
                    ...
                    if j.getAttribute("name") == "attributes":
                        for l in j.getElementsByTagName("dia:composite"):
                            if l.getAttribute("type") == "umlattribute":
                                ...
                                for k in l.getElementsByTagName(
                                    "dia:attribute"
                                ):
            ...
            for j in a:
                if len(j.getAttribute("to")):
                    mycons[int(j.getAttribute("handle"))] = j.getAttribute(
                        "to"
                    )
            print(mycons)
            if "A" not in mycons:
    ...
    while i < len(ordered):
        ...
        if mark == i:
            ...
            if (
                ordered[i][0] in ordered[mark][1]
                and ordered[mark][0] in ordered[i][1]
            ):

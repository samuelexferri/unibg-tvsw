...
slugify_function_path = getattr(
    settings, "AUTOSLUG_SLUGIFY_FUNCTION", "autoslug.utils.slugify"
)
slugify = get_callable(slugify_function_path)

# enable/disable modeltranslation support
autoslug_modeltranslation_enable = getattr(
    settings, "AUTOSLUG_MODELTRANSLATION_ENABLE", False
)

...
class PathSpecTest(unittest.TestCase):
    ...
    def test_01_current_dir_paths(self):
        ...
        self.assertEqual(
            results,
            {"./src/test2/a.txt", "./src/test2/b.txt", "./src/test2/c/c.txt",},
        )
    ...
    def test_02_ne(self):
		...
		Tests equality.
		"""
        first_spec = pathspec.PathSpec.from_lines("gitwildmatch", ["*.txt",])
        second_spec = pathspec.PathSpec.from_lines("gitwildmatch", ["!*.txt",])

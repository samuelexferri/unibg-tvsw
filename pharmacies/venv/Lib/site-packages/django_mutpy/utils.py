...
def list_all_modules_in_package(package_name, include_list, skip):
    ...
    for importer, modname, ispkg in pkgutil.iter_modules(package.__path__):
        ...
        if ispkg:
            modlist += list_all_modules_in_package(
                full_modname, include_list=include_list, skip=skip
            )
        elif modname not in skip and (
            not include_list or full_modname in include_list
        ):

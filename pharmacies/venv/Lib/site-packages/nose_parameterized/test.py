...
class TestParameterizedExpandDocstring(TestCase):
    def _assert_docstring(self, expected_docstring, rstrip=False):
        ...
        test_method = f_locals.get("testMethod") or f_locals.get(  # Py27
            "function"
        )  # Py33
...
expect("generator", ["test_wrapped_iterable_input('foo')",])
...
@parameterized(
    [
        ...
        (
            123456789,
            "123...789",
        ),  # number types do not have quotes, so we can repr more
    ]
)

    ...
    if sys.version_info[0] <= 2:
        ...
        try:
            ...
            checker = get_checker(
                linter,
                get_class(
                    checker_method.__module__, checker_method.__qualname__
                ),
            )
...
def supress_message(linter, checker_method, message_id, test_func):
    ...
    warnings.warn(
        "'supress_message' has been deprecated in favour of the correctly-spelled 'suppress_message'",
        DeprecationWarning,
    )
...
def suppress_message(linter, checker_method, message_id_or_symbol, test_func):
    ...
    def get_message_definitions(message_id_or_symbol):
        ...
        # https://github.com/PyCQA/pylint/commit/da67a9da682e51844fbc674229ff6619eb9c816a
            ...
            raise ValueError(
                "pylint.utils.MessagesStore does not have a get_message_definition(s) method"
            )

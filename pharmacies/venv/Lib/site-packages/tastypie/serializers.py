...
class Serializer(object):
    ...
    def __init__(
        self, formats=None, content_types=None, datetime_formatting=None
    ):
        ...
        if self.formats is Serializer.formats and hasattr(
            settings, "TASTYPIE_DEFAULT_FORMATS"
        ):
    ...
    def to_simple(self, data, options):
        ...
        if stype == _BUNDLE:
            ...
            return {
                key: to_simple(val, options)
                for key, val in six.iteritems(data.data)
            }
        if stype == _DATETIME:
    ...
    def from_etree(self, data):
        ...
        if data.tag == "request":
            ...
            return {
                element.tag: self.from_etree(element) for element in elements
            }
    ...
    def to_jsonp(self, data, options=None):
        ...
        options = options or {}
        jsonstr = (
            self.to_json(data, options)
            .replace("\u2028", "\\u2028")
            .replace("\u2029", "\\u2029")
        )
        return "%s(%s)" % (options["callback"], jsonstr)

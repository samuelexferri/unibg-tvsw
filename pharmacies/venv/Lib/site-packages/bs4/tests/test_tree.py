...
class TestFindAll(TreeTest):
    ...
    def test_find_all_text_nodes(self):
        ...
        self.assertEqual(soup.find_all(text=["Foo", "bar"]), ["Foo", "bar"])
        # Match a regular expression.
        self.assertEqual(
            soup.find_all(text=re.compile(".*")), ["Foo", "bar", "\xbb"]
        )
        # Match anything.
        self.assertEqual(soup.find_all(text=True), ["Foo", "bar", "\xbb"])
...
class TestFindAllByAttribute(TreeTest):
    ...
    def test_find_all_by_utf8_attribute_value(self):
        ...
        self.assertEqual(
            [soup.a], soup.find_all(title=[peace, "something else"])
        )
...
class TestTreeModification(SoupTest):
    ...
    def test_consecutive_text_nodes(self):
        ...
        self.assertEqual(
            soup.decode(),
            self.document_for("<a><b>Argh!Hooray!</b><c></c></a>"),
        )
    ...
    def test_extend(self):
        ...
        soup.a.extend(l)
        self.assertEqual(
            "<a><g></g><f></f><e></e><d></d><c></c><b></b></a>", soup.decode()
        )
    ...
    def test_insert_multiple_before(self):
        ...
        self.assertEqual(
            soup.decode(),
            self.document_for("QUUX BAZ<a>foo</a>BAZ QUUX<b>bar</b>"),
        )

        soup.a.insert_before(soup.b, "FOO")
        self.assertEqual(
            soup.decode(),
            self.document_for("QUUX BAZ<b>bar</b>FOO<a>foo</a>BAZ QUUX"),
        )
    ...
    def test_insert_multiple_after(self):
        ...
        self.assertEqual(
            soup.decode(),
            self.document_for("<a>foo</a>QUUX BAZ<b>bar</b>BAZ QUUX"),
        )
        soup.b.insert_after(soup.a, "FOO ")
        self.assertEqual(
            soup.decode(),
            self.document_for("QUUX BAZ<b>bar</b><a>foo</a>FOO BAZ QUUX"),
        )
    ...
    def test_nested_tag_replace_with(self):
        ...
        self.assertEqual(
            soup.decode(),
            self.document_for("<a>We<f>refuse</f></a><e>to<g>service</g></e>"),
        )
    ...
    def test_wrap_puts_new_contents_at_the_end(self):
        ...
        self.assertEqual(
            soup.decode(),
            self.document_for("<b>I like being bold.I wish I was bold.</b>"),
        )
...
<a href="foo"><b>bar</b></a>
    ...
    def test_copy_preserves_builder_information(self):
        ...
        self.assertEqual(tag.can_be_empty_element, copied.can_be_empty_element)
        self.assertEqual(
...
class TestSubstitutions(SoupTest):
    ...
    def test_formatter_custom(self):
        ...
        self.assertEqual(
            decoded, self.document_for("<b><FOO></b><b>BAR</b><br/>")
        )
...
class TestEncoding(SoupTest):
    ...
    def test_unicode_string_can_be_encoded(self):
        ...
        soup = self.soup(html)
        self.assertEqual(
            soup.b.string.encode("utf-8"), "\N{SNOWMAN}".encode("utf-8")
        )
    ...
    def test_encode_contents(self):
        ...
        soup = self.soup(html)
        self.assertEqual(
            "\N{SNOWMAN}".encode("utf8"),
            soup.b.encode_contents(encoding="utf8"),
        )

    def test_deprecated_renderContents(self):
        html = "<b>\N{SNOWMAN}</b>"
        soup = self.soup(html)
        self.assertEqual("\N{SNOWMAN}".encode("utf8"), soup.b.renderContents())
...
"""
    ...
    def test_select_dashed_matches_find_all(self):
        self.assertEqual(
            self.soup.select("custom-dashed-tag"),
            self.soup.find_all("custom-dashed-tag"),
        )

    def test_header_tags(self):
        self.assertSelectMultiple(
            ("h1", ["header1"]), ("h2", ["header2", "header3"]),
        )
    ...
    def test_unsupported_pseudoclass(self):
        ...
        self.assertRaises(SyntaxError, self.soup.select, "a:nth-of-type(a)")

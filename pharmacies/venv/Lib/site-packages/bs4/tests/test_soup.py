...
class TestWarnings(SoupTest):
    ...
    def test_parseOnlyThese_renamed_to_parse_only(self):
        with warnings.catch_warnings(record=True) as w:
            soup = self.soup(
                "<a><b></b></a>", parseOnlyThese=SoupStrainer("b")
            )
        msg = str(w[0].message)
...
class TestWarnings(SoupTest):
    ...
    def test_url_warning_with_bytes_url(self):
        ...
        # execution..
        self.assertTrue(
            any("looks like a URL" in str(w.message) for w in warning_list)
        )
...
class TestEntitySubstitution(unittest.TestCase):
    ...
    def test_simple_html_substitution(self):
        ...
        self.assertEqual(
            self.sub.substitute_html(s), "foo&forall;\N{SNOWMAN}&otilde;bar"
        )
    ...
    def test_smart_quote_substitution(self):
        ...
        self.assertEqual(
            self.sub.substitute_html(dammit.markup),
    ...
    def test_xml_attribute_quoting_normally_uses_double_quotes(self):
        ...
        self.assertEqual(
            self.sub.substitute_xml("Bob's Bar", True), '"Bob\'s Bar"'
        )
    ...
    def test_xml_attribute_quoting_uses_single_quotes_when_value_contains_double_quotes(
        ...
        s = 'Welcome to "my bar"'
        self.assertEqual(
            self.sub.substitute_xml(s, True), "'Welcome to \"my bar\"'"
        )
    ...
    def test_xml_quoting_including_ampersands_when_they_are_part_of_an_entity(
        ...
        self.assertEqual(
            self.sub.substitute_xml("&Aacute;T&T"), "&amp;Aacute;T&amp;T"
        )
...
class TestEncodingConversion(SoupTest):
    ...
    def test_ascii_in_unicode_out(self):
        ...
        try:
            ...
            self.assertEqual(
                soup_from_ascii.original_encoding.lower(), "utf-8"
            )
        finally:
...
<i>\310\322\321\220\312\321\355\344</i></html>"""
    ...
    def test_find_declared_encoding(self):
        ...
        self.assertEqual(
            "iso-8859-1", m(xml_bytes, search_entire_document=True)
        )
        self.assertEqual(

...
class PageElement(object):
    ...
    def find_all_next(
        ...
        return self._find_all(
            name, attrs, text, limit, self.next_elements, **kwargs
        )
    ...
    def find_next_sibling(self, name=None, attrs={}, text=None, **kwargs):
        ...
        return self._find_one(
            self.find_next_siblings, name, attrs, text, **kwargs
        )
    ...
    def find_next_siblings(
        ...
        """
        return self._find_all(
            name, attrs, text, limit, self.next_siblings, **kwargs
        )
    ...
    def find_all_previous(
        ...
        """
        return self._find_all(
            name, attrs, text, limit, self.previous_elements, **kwargs
        )
    ...
    def find_previous_sibling(self, name=None, attrs={}, text=None, **kwargs):
        ...
        """
        return self._find_one(
            self.find_previous_siblings, name, attrs, text, **kwargs
        )
    ...
    def find_previous_siblings(
        ...
        """
        return self._find_all(
            name, attrs, text, limit, self.previous_siblings, **kwargs
        )
...
class Tag(PageElement):
    ...
    def get_text(
        self, separator="", strip=False, types=(NavigableString, CData)
    ):
    ...
    def decode(
        ...
        if self.hidden:
            ...
            s.append(
                "<%s%s%s%s>" % (prefix, self.name, attribute_string, close)
            )
            if pretty_print:
                s.append("\n")
            s.append(contents)
    ...
    def decode_contents(
        ...
        for c in self:
            ...
            preserve_whitespace = (
                ...
                and self.name in self.preserve_whitespace_tags
            )
    ...
    def search(self, markup):
        ...
        # If it's text, make sure the text matches.
            ...
            if (
                not self.name
                and not self.attrs
                and self._matches(markup, self.text)
            ):
                found = markup
        else:
            raise Exception(

...
class UsageError(ClickException):
    ...
    def show(self, file=None):
        ...
        if self.ctx is not None:
            ...
            echo(
                "{}\n{}".format(self.ctx.get_usage(), hint),
                file=file,
                color=color,
            )
...
class NoSuchOption(UsageError):
    ...
    def __init__(
        self, option_name, message=None, possibilities=None, ctx=None
    ):
        if message is None:
    ...
    def format_message(self):
        ...
        if self.possibilities:
            if len(self.possibilities) == 1:
                ...
                bits.append(
                    "(Possible options: {})".format(", ".join(possibilities))
                )
        return "  ".join(bits)
...
class FileError(ClickException):
    ...
    def format_message(self):
        return "Could not open file {}: {}".format(
            self.ui_filename, self.message
        )

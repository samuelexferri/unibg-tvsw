...
def _maybe_show_deprecated_notice(cmd):
    if cmd.deprecated:
        echo(
            style(DEPRECATED_INVOKE_NOTICE % {"name": cmd.name}, fg="red"),
            err=True,
        )
...
def invoke_param_callback(callback, ctx, param, value):
    ...
    if args < 3:
        ...
        warn(
            ...
            " 2-arg style is deprecated and will be removed in 8.0.".format(
                callback
            ),
            DeprecationWarning,
            stacklevel=3,
    ...
    def resultcallback(self, replace=False):
        ...
        def decorator(f):
            ...
            def function(__value, *args, **kwargs):
                return f(
                    old_callback(__value, *args, **kwargs), *args, **kwargs
                )
...
class Parameter(object):
    ...
    def type_cast_value(self, ctx, value):
        ...
        if self.type.is_composite:
            ...
            if self.multiple:
                return tuple(
                    self.type(x or (), self, ctx) for x in value or ()
                )
...
class Option(Parameter):
    ...
    def __init__(
        ...
        **attrs
        ...
        if (
            self.is_flag
            and isinstance(self.flag_value, bool)
    ...
    def _parse_decls(self, decls, expose_value):
        ...
        if not opts and not secondary_opts:
            raise TypeError(
                ...
                " mean to declare an argument instead of an option?".format(
                    name
                )
            )
    ...
    def add_to_parser(self, parser, ctx):
        ...
        if self.is_flag:
            ...
            if self.is_bool_flag and self.secondary_opts:
                parser.add_option(
                    self.opts, action=action_const, const=True, **kwargs
                )
                parser.add_option(
                    self.secondary_opts,
                    action=action_const,
        ...
        if self.show_envvar:
            ...
            if envvar is None:
                if (
                    ...
                    envvar = "{}_{}".format(
                        ctx.auto_envvar_prefix, self.name.upper()
                    )

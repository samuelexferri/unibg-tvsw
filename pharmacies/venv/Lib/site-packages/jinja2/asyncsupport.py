...
class AsyncLoopContext(LoopContextBase):
    def __init__(
        self, async_iterator, undefined, after, length, recurse=None, depth0=0
    ):
    ...
    def length(self):
        if self._length is None:
            raise TypeError(
                "Loop length for some iterators cannot be "
...
async def make_async_loop_context(iterable, undefined, recurse=None, depth0=0):
    ...
    return AsyncLoopContext(
        async_iterator, undefined, after, length, recurse, depth0
    )

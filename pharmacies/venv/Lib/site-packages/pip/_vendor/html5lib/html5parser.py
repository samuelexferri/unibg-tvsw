    ...
    def isHTMLIntegrationPoint(self, element):
        if (
            ...
            return (
                element.namespace,
                element.name,
            ) in htmlIntegrationPointElements

    def isMathMLTextIntegrationPoint(self, element):
        return (
            element.namespace,
            element.name,
        ) in mathmlTextIntegrationPointElements
        ...
        for token in self.normalizedTokens():
            ...
            while new_token is not None:
                ...
                currentNodeNamespace = (
                    currentNode.namespace if currentNode else None
                )
                ...
                if type == ParseErrorToken:
                    self.parseError(
                        new_token["data"], new_token.get("datavars", {})
                    )
                    new_token = None
                else:
                    if (
                        ...
                        or (
                            ...
                            and (
                                ...
                                or type
                                in (CharactersToken, SpaceCharactersToken)
                            )
                        )
                        or (
...
def getPhases(debug):
    ...
    class InHeadNoscriptPhase(Phase):
        ...
        def endTagNoscript(self, token):
            ...
            assert node.name == "noscript", (
                "Expected noscript got %s" % node.name
            )
            self.parser.phase = self.parser.phases["inHead"]
    ...
    class InBodyPhase(Phase):
        ...
        def __init__(self, parser, tree):
            ...
            self.endTagHandler = _utils.MethodDispatcher(
                [
                    ...
                    (
                        ("applet", "marquee", "object"),
                        self.endTagAppletMarqueeObject,
                    ),
                    ("br", self.endTagBr),
                ]
            )
        ...
        def processSpaceCharactersDropNewline(self, token):
            ...
            if (
                data.startswith("\n")
                and self.tree.openElements[-1].name
                in ("pre", "listing", "textarea")
        ...
        def startTagPreListing(self, token):
            ...
            self.tree.insertElement(token)
            self.parser.framesetOK = False
            self.processSpaceCharacters = (
                self.processSpaceCharactersDropNewline
            )
        ...
        def startTagInput(self, token):
            ...
            if (
                "type" in token["data"]
                and token["data"]["type"].translate(asciiUpper2Lower)
                == "hidden"
            ):
            ...
            while outerLoopCounter < 8:
                ...
                while innerLoopCounter < 3:
                    ...
                    if lastNode == furthestBlock:
                        bookmark = (
                            self.tree.activeFormattingElements.index(node) + 1
                        )
                    # Step 9.8
                    ...
                    self.tree.openElements[
                        self.tree.openElements.index(node)
                    ] = clone
                    node = clone
                    # Step 9.9
                ...
                if commonAncestor.name in frozenset(
                    ...
                    (
                        parent,
                        insertBefore,
                    ) = self.tree.getTableMisnestedNodePosition()
    ...
    class InForeignContentPhase(Phase):
        ...
        def processStartTag(self, token):
            ...
            if token["name"] in self.breakoutElements or (
                ...
                while (
                    self.tree.openElements[-1].namespace

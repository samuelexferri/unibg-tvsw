        ...
        if not hasattr(element, "tag"):
            if hasattr(element, "getroot"):
                ...
                if element.docinfo.internalDTD:
                    if not (
                        element.docinfo.public_id or element.docinfo.system_url
                    ):
...
class TreeBuilder(base.TreeBuilder):
    ...
    def insertDoctype(self, token):
        ...
        if not name:
            warnings.warn(
                "lxml cannot represent empty doctype", DataLossWarning
            )
            self.doctype = None
        else:
    ...
    def insertRoot(self, token):
        ...
        if self.doctype:
            ...
            if (
                self.doctype.publicId is not None
                or self.doctype.systemId is not None
            ):
                docStr += ' PUBLIC "%s" ' % (

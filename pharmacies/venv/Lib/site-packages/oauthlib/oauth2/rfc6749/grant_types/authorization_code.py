...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    def create_authorization_code(self, request):
        ...
        log.debug(
            "Created authorization code grant %r for request %r.",
            grant,
            request,
        )
        return grant
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        try:
            ...
            log.debug(
                "Pre resource owner authorization validation ok for %r.",
                request,
            )
        ...
        # invalid redirection URI.
            ...
            log.debug(
                "Fatal client error during validation of %r. %r.", request, e
            )
            raise
    ...
    def validate_authorization_request(self, request):
        ...
        # response_types "code token", "code id_token", "code token id_token"
            ...
            not "code" in request.response_type
            and request.response_type != "none"
        ):
        ...
        if (
            self.request_validator.is_pkce_required(request.client_id, request)
            is True
        ):
        ...
        if request.code_challenge is not None:
            ...
            if (
                ...
                not in self._code_challenge_methods
            ):
    ...
    def validate_code_challenge(self, challenge, challenge_method, verifier):
        if challenge_method in self._code_challenge_methods:
            return self._code_challenge_methods[challenge_method](
                verifier, challenge
            )
        raise NotImplementedError(
            "Unknown challenge_method %s" % challenge_method
        )

...
class Client(object):
    ...
    def get_oauth_signature(self, request):
        ...
        normalized_uri = signature.base_string_uri(
    ...
    def get_oauth_params(self, request):
        ...
        content_type_eligible = (
            content_type
            and content_type.find("application/x-www-form-urlencoded") < 0
        )
    ...
    def sign(
        self, uri, http_method="GET", body=None, headers=None, realm=None
    ):
        """Sign a request
        ...
        request = Request(
            uri, http_method, body, headers, encoding=self.encoding
        )

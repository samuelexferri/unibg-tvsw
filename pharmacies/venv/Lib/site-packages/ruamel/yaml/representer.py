...
class BaseRepresenter(object):
    ...
    def __init__(
        self, default_style=None, default_flow_style=None, dumper=None
    ):
    ...
    def represent_data(self, data):
        ...
        if PY2:
            ...
            if isinstance(data, types.InstanceType):
                data_types = get_classobj_bases(data.__class__) + list(
                    data_types
                )
...
class SafeRepresenter(BaseRepresenter):
    ...
    if PY3:
        ...
        def represent_binary(self, data):
            ...
            return self.represent_scalar(
                u"tag:yaml.org,2002:binary", data, style="|"
            )
    ...
    def represent_bool(self, data, anchor=None):
        ...
        try:
            ...
            if data:
                ...
                value = u"false"
        return self.represent_scalar(
            u"tag:yaml.org,2002:bool", value, anchor=anchor
        )
    ...
    if PY2:
        ...
        def represent_long(self, data):
            # type: (Any) -> Any
            return self.represent_scalar(
                u"tag:yaml.org,2002:int", text_type(data)
            )
...
class Representer(SafeRepresenter):
    ...
    def represent_name(self, data):
        ...
        return self.represent_scalar(
            u"tag:yaml.org,2002:python/name:" + name, ""
        )
...
class RoundTripRepresenter(SafeRepresenter):
    ...
    def represent_mapping(self, tag, mapping, flow_style=None):
        ...
        if bool(merge_list):
            ...
            if len(merge_list) == 1:
                ...
                arg.flow_style = True
            value.insert(
                merge_pos, (ScalarNode(u"tag:yaml.org,2002:merge", "<<"), arg)
            )
        return node
    ...
    def represent_datetime(self, data):
        ...
        if _yaml["tz"]:
            value += _yaml["tz"]
        return self.represent_scalar(
            u"tag:yaml.org,2002:timestamp", to_unicode(value)
        )

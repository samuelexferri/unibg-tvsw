...
class Scanner(object):
    def __init__(self, loader=None):
        ...
        if (
            ...
            and getattr(self.loader, "_scanner", None) is None
        ):
    ...
    def fetch_stream_start(self):
        ...
        # Add STREAM-START.
        self.tokens.append(
            StreamStartToken(mark, mark, encoding=self.reader.encoding)
        )
    ...
    def scan_block_scalar(self, style, rt=False):
        ...
        # We are done.
        token = ScalarToken(
            "".join(chunks), False, start_mark, end_mark, style
        )
    ...
    def get_token(self):
        ...
        if bool(self.tokens):
            ...
            if (
                ...
                c = self.tokens.pop(1)
                self.fetch_more_tokens()
                while len(self.tokens) > 1 and isinstance(
                    self.tokens[1], CommentToken
                ):
                    self.tokens_taken += 1

...
class _UIRenderer(BaseRenderer):
    ...
    def set_context(self, renderer_context, swagger=None):
        ...
        renderer_context["version"] = (
            swagger.info.version or "" if swagger else ""
        )
...
class SwaggerUIRenderer(_UIRenderer):
    ...
    def set_context(self, renderer_context, swagger=None):
        ...
        oauth_redirect_url = force_str(
            swagger_ui_settings.get("oauth2RedirectUrl", "")
        )
        if request and oauth_redirect_url:
            swagger_ui_settings[
                "oauth2RedirectUrl"
            ] = request.build_absolute_uri(oauth_redirect_url)
    ...
    def get_swagger_ui_settings(self):
        ...
        if swagger_settings.VALIDATOR_URL != "":
            data["validatorUrl"] = self.resolve_url(

...
def is_callable_method(cls_or_instance, method_name):
    ...
    try:
        ...
        return (
            method,
            isinstance(
                getattr_static(cls_or_instance, method_name, None),
                staticmethod,
            ),
        )
    except ImportError:
...
class BaseInspector(object):
    ...
    def probe_inspectors(
        self, inspectors, method_name, obj, initkwargs=None, **kwargs
    ):
        ...
        for inspector in reversed(tried_inspectors):
            result = inspector.process_result(
...
class FieldInspector(BaseInspector):
    ...
    def __init__(
        self, view, path, method, components, request, field_inspectors
    ):
        super(FieldInspector, self).__init__(
            view, path, method, components, request
        )
...
class ViewInspector(BaseInspector):
    ...
    def get_operation(self, operation_keys):
        ...
        raise NotImplementedError(
            "ViewInspector must implement get_operation()!"
        )
    ...
    def should_filter(self):
        ...
        """
        return (
            getattr(self.view, "filter_backends", None)
            and self.has_list_response()
        )
    ...
    def should_page(self):
        ...
        """
        return (
            getattr(self.view, "paginator", None) and self.has_list_response()
        )

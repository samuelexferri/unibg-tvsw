...
def get_schema_view(
    ...
    _public = public
    _generator_class = (
        generator_class or swagger_settings.DEFAULT_GENERATOR_CLASS
    )
    ...
    class SchemaView(APIView):
        ...
        def get(self, request, version="", format=None):
            ...
            if isinstance(request.accepted_renderer, _SpecRenderer):
                generator = self.generator_class(
                    info, version, url, patterns, urlconf
                )
            else:
                generator = self.generator_class(
                    info, version, url, patterns=[]
                )
        ...
        @classmethod
        def as_cached_view(
            cls, cache_timeout=0, cache_kwargs=None, **initkwargs
        ):
            """
        ...
        @classmethod
        def with_ui(
            cls, renderer="swagger", cache_timeout=0, cache_kwargs=None
        ):
            """

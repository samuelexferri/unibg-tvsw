    ...
    def __init__(
        ...
        if self._dtstart and self._until:
            if (self._dtstart.tzinfo is not None) != (
                self._until.tzinfo is not None
            ):
                ...
                for minute in self._byminute:
                    for second in self._bysecond:
                        self._timeset.append(
                            datetime.time(
                                hour, minute, second, tzinfo=self._tzinfo
                            )
                        )
            self._timeset.sort()
    ...
    def __str__(self):
        ...
        for name, key in [
            ...
            if value:
                parts.append(
                    partfmt.format(
                        name=name, vals=(",".join(str(v) for v in value))
                    )
                )
                ...
                if no1wkst:
                    ...
                    if -1 not in rr._byweekno:
                        ...
                        if lno1wkst >= 4:
                            ...
                            lnumweeks = (
                                52
                                + (lyearlen + (lyearweekday - rr._wkst) % 7)
                                % 7
                                // 4
                            )
                        else:

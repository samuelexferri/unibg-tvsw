...
def is_file(obj):
    ...
    if hasattr(obj, "__iter__") and not isinstance(
        obj, (string_types, list, tuple, dict)
    ):
        # A stream object.
        return True
...
def _validate_form_object(value, allow_files=False):
    ...
    if not isinstance(value, dict):
        ...
        raise exceptions.ParameterError(msg)
    return {
        text_type(item_key): _validate_form_field(
            item_val, allow_files=allow_files
        )
...
def _validate_form_field(value, allow_files=False, allow_list=True):
    ...
    if isinstance(value, string_types):
        ...
        allow_list and isinstance(value, (list, tuple)) and not is_file(value)
    ):

...
jsonschema = coreschema.RefSpace(
    {
        "Schema": coreschema.Object(
            properties={
                ...
                # Type
                "type": coreschema.Ref("SimpleTypes")
                | coreschema.Array(
                ...
                "additionalItems": coreschema.Boolean()
                ...
                "additionalProperties": coreschema.Boolean()
                ...
                "dependancies": coreschema.Object(
        ...
        "SchemaArray": coreschema.Array(
            items=coreschema.Ref("Schema"), min_items=1,
        ),
...
def get_composite_schemas(data):
    ...
    if "anyOf" in data:
        value = data["anyOf"]
        schema = coreschema.Union([load_jsonschema(item) for item in value])

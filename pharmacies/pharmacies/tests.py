...
class TestPermissions(TestCase):
    ...
    def test_permissions_IsAdminOrReadOnly_true(self):
        ...
        self.request.user.is_superuser = True
        self.view = MagicMock()
        self.assertTrue(IsAdminOrReadOnly.has_permission(self, self.request, self.view))
    ...
    def test_permissions_IsStaffOrReadOnly_true(self):
        ...
        self.request.user.is_staff = True
        self.view = MagicMock()
        self.assertTrue(IsStaffOrReadOnly.has_permission(self, self.request, self.view))

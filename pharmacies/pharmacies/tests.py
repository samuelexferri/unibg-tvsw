...
class TestPermissions(TestCase):
    def test_permissions_IsAdmin_true(self):
        ...
        self.view = MagicMock()
        self.assertTrue(
            IsAdmin.has_permission(self.request, self.request, self.view)
        )
    ...
    def test_permissions_IsStaff_true(self):
        ...
        self.view = MagicMock()
        self.assertTrue(
            IsStaff.has_permission(self.request, self.request, self.view)
        )
    ...
    def test_permissions_IsAdminOrReadOnly_true(self):
        ...
        self.assertTrue(
            IsAdminOrReadOnly.has_permission(
                self.request, self.request, self.view
            )
        )
    ...
    def test_permissions_IsStaffOrReadOnly_true(self):
        ...
        self.view = MagicMock()
        self.assertTrue(
            IsStaffOrReadOnly.has_permission(
                self.request, self.request, self.view
            )
        )
